...
export default function Profile() {
  ...
  return (
    <div className='md:flex md:mx-[5%] lg:mx-[10%] lg:px-[10%] gap-x-[16%] pt-[4%] mt-4'>

      {user &&

        <>
          <div className="flex flex-col items-center gap-y-3 mb-4">
            <Avatar size='120px' radius="100px" styles={{ placeholder: { backgroundColor: '#EA7C3D', color: '#fff', textTransform: 'capitalize' } }}>{user.email?.[0]}</Avatar>
            <p className='text-xl font-semibold capitalize'>{user.email?.split('@')[0]} </p>
          ...
          <Tabs defaultValue="memes">
            <Tabs.List className='mx-auto md:mx-0 w-fit'>
